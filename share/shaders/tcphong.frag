...
void main() {
    ...
    for (int i = 0; i < 16; ++i) {
        ...
        Idiff += diffuse(vcolor * texel.rgb * material.diffuse, light_intensity, normal, light_vector);
        Ispec += specular(vcolor * texel.rbg * material.specular, light_intensity, reflect(-light_vector, normal),
